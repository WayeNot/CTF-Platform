            ...
            <div className="flex items-start gap-8 w-full my-5">
                <div className="flex flex-col gap-5 flex-1">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <textarea className="p-2 border border-white/10 bg-white/5 text-gray-300 hover:bg-white/10 hover:text-white transition duration-500 resize-none h-25" placeholder="Tell us a little bit about yourself" value={bio} onChange={e => updateBio(e.target.value)} />
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-3">
                        <button onClick={updateProfile} className="text-[12px] w-fit font-semibold text-gray-300 p-2 border border-white/10 bg-white/5 hover:bg-white/10 hover:text-white transition duration-500 cursor-pointer">Update profile</button>
